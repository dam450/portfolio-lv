  ...
  return (
    <section id="about" className="pt-9 pb-9">
      <div>
        ...
        <h2 className="font-bold text-4xl mb-7 animate-scroll_review">Sobre</h2>
      </div>

      <div className="text-left grid lg:grid-cols-2 gap-x-12 gap-y-6">
        <div className="animate-scroll_review">
          <p>
        ...
        <div>
          <h3 className="text-lg font-bold mb-2 animate-scroll_review">
            Habilidades Técnicas:
          </h3>
          <ul className="list-disc pl-6 animate-scroll_review">
            <li>
              <span className="font-bold text-primary-400">Linguagens: </span>{" "}
        ...
        <div className="*:mb-3">
          <h3 className="text-lg font-bold animate-scroll_review">
        ...
        <div className="*:mb-8">
          <div>
            ...
            <p className="animate-scroll_review">
              <span className="font-bold text-primary-400">PlantAI </span>-
          ...
          <div className="flex flex-row gap-2">
            {/* github */}
            <a
              className="rounded-full border-2 border-transparent hover:border-primary-400 transition-colors duration-300 animate-scroll_review animate-pulse"
            ...
            >
              ...
              >
                <title>link para o Github</title>
                <rect
                  width="27"
                  height="27"
                  rx="13.5"
